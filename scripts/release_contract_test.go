...
func TestRegistryAndReleaseContractUseVersion013(t *testing.T) {
	...
	if registry.SchemaVersion != 1 || len(registry.Plugins) != 1 || registry.Plugins[0].ID != "cpa-codex-auto-reset" || registry.Plugins[0].Version != "0.1.3" {
